    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if img in ck:
                ...
                body = f"The {img} you uploaded was verified successfully. You have got 10 points for that. Our guy will be collecting the box from you asap! and once the verification is done. The verification will be done with the help of the qrcode attached. You will be getting the reward once you get 100 points."
